...
const service = {
  ...
  playerSettingsItems: () => FIND_MANY_RESULT,
  playerSettings: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("PlayerSettings", () => {
  ...
  test("POST /playerSettings", async () => {
  ...
  test("GET /playerSettings/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/playerSettings"}/${nonExistingId}`)
  ...
  test("GET /playerSettings/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/playerSettings"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /playerSettings existing resource", async () => {
